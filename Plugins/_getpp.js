const handler = async (m, { katsumi, reply, text }) => {
...
var ppuser
try {
ppuser = await katsumi.profilePictureUrl(target, 'image')
} catch (err) {
ppuser = 'https://files.catbox.moe/ejy4ky.jpg'
}
return katsumi.sendMessage(m.chat, {image: {url: ppuser}, caption: `Sukses mengambil profil @${target.split("@")[0]}`, mentions: [target]}, {quoted: m})
}
