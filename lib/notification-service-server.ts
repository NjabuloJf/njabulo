...
// This ensures that functions like trackPairingEvent are not confused with their client-side namesakes.
...
export async function trackPairingEvent(pairingData: {
  ...
  try {
    ...
    console.error("[Server] Error tracking pairing event:", error)
    return null
  }
}
