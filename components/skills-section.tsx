  ...
  return (
    <section className="min-h-screen py-20 md:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <ScrollAnimator>
          <div className="p-8 md:p-10 rounded-2xl bg-card/50 border border-primary/20 space-y-6">
            <div className="flex items-center gap-3 justify-center">
              <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center">
                <BarChart3 size={24} className="text-primary" />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold text-foreground">Proficiency Summary</h3>
            </div>
